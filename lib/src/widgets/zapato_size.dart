...
import 'package:contador/src/pages/zapato_desc_page.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class ZapatoSizePreview extends StatelessWidget {

  final bool fullScrren;

  ZapatoSizePreview({this.fullScrren=true});
    ...
    return GestureDetector(
      ...
      child: Padding(
        padding: EdgeInsets.symmetric(
          horizontal: (this.fullScrren)?5:30,
          vertical: (this.fullScrren)?0:5
        ),
        child: Container(
          width: double.infinity,
          height: (!this.fullScrren) ? 410:430,
